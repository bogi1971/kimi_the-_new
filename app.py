...
TELEGRAM_BOT_TOKEN = "123456789:ABCdefGHIjklMNOpqrSTUvwxyz123456789"  # <-- DEIN BOT TOKEN HIER
TELEGRAM_CHAT_ID = "123456789"  # <-- DEINE CHAT ID HIER
...
ALPHA_VANTAGE_KEYS = [
    "A1B2C3D4E5F6G7H8",  # <-- KEY 1 HIER
    "I9J0K1L2M3N4O5P6",  # <-- KEY 2 HIER (optional)
    "Q7R8S9T0U1V2W3X4"   # <-- KEY 3 HIER (optional)
]

# ============================================
# ODER verwende Umgebungsvariablen (sicherer):
# ============================================
...
def analyze_news_tiered(symbol, tier, score):
    ...
    if tier <= 20 or score > 60:
        ...
        if news:
            sources = ['FH']
            # Boost Score basierend auf News-Sentiment (hier vereinfacht)
            for item in news[:1]:  # Top-News
    ...
    # Für niedrigere Tiers: Yahoo Finance News (simuliert durch leere Liste oder Fallback)
    return [], [], False
...
def analyze_smart(symbol, tier, total_tickers, market_ctx=None):
    ...
    # Akzeptiere nur höhere lows oder HH+HL
